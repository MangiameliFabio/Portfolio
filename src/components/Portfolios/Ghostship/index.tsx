...
const selectedProjectTitles = [
  "Hypothermia - Game and Network Programming",
  "Halls of Torment - Performance optimizations and Profiling",
...
const selectedProjects = selectedProjectTitles.flatMap((title) => {
