    ...
    <>
      ...
      >
        <div className="container">
          <div className="mb-10 flex flex-row items-center md:mb-20">
            ...
            <div className="max-w-[900px] flex flex-col justify-items-center">
              ...
              <p className="mb-4 text-base leading-relaxed! text-black dark:text-white sm:text-lg md:text-xl">
                My name is Fabio Mangiameli. I currently study Game Technology at
                the IT University of Copenhagen. I also work as a game
          ...
          <h1 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white sm:text-3xl sm:leading-tight md:mb-10 md:text-4xl md:leading-tight">
